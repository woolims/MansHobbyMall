        ...
        IMP.request_pay({
            ...
            if (rsp.success) {
                ...
                jQuery.ajax({
                    ...
                    // 가맹점 서버 결제 API 성공시 로직
                    jQuery.ajax({
                        url: "../buyList/buy.do", // 서버의 결제 정보를 받는 가맹점 endpoint
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json"
                        },
                        data: JSON.stringify({
                            imp_uid: data.imp_uid, // 결제 고유번호
                        ...
                        success: function (response) {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (tokenResponse) {
                                    var access_token = tokenResponse
                                        .response.access_token; // 발급된 토큰
                        ...
                        error: function (error) {
                            console.error("결제 실패:", error.responseText);
                        }
                    });
                })
            } else {
