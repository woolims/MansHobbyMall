            ...
            <div class="tab-content" style="min-height: 850px;">
                ...
                <div id="menu2" class="tab-pane">
                    ...
                    <div class="form-group" style="display: inline-block;">
                        <select class="form-control" name="categorySearch" id="categorySearch" style="width: 150px;"
                            onchange="mcategoryName(this.value);">
                    ...
                    <div class="form-group" style="display: inline-block;">
                        <select class="form-control" name="mcategorySearch" id="mcategorySearch" style="width: 150px;"
                            onchange="dcategoryName(this.value);">
                                    ...
                                    <table style="margin-top: 10px;">
                                        ...
                                        <tr style="text-align: center;">
                                            <td style="padding: 6px;">
                                                ${pVo.getPIdx()}</td>
                                            <td>
                                                ${pVo.getCategoryName()}</td>
                                            <td>
                                                ${pVo.getMcategoryName()}</td>
                                            <td style="padding: 12px;">
                                                ${pVo.getDcategoryName()}</td>
                                            <td>
                                                ${pVo.getPName()}</td>
                                            <td>
                                                ${pVo.getAmount()}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form style="display: inline;">
                                                ...
                                                <input type="button" class="btn btn-default" name="nModify" id="nModify"
