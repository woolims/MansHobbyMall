...
-- Grade 테이블
CREATE TABLE Grade (
    gIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
-- User 테이블
CREATE TABLE User (
    userIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
-- Email 테이블
CREATE TABLE Email (
    emailIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE DAddress (
    daIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    userIdx int NOT NULL,
...
CREATE TABLE GCondition (
    jIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    userIdx int NOT NULL,
...
-- Coupon 테이블
CREATE TABLE coupon (
    cIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE CouponBox (
    cbIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    userIdx int NOT NULL,
    cIdx int NOT NULL,
...
CREATE TABLE Category (
    categoryNo int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    categoryName varchar(200) NOT NULL
);

-- DCategory 테이블
CREATE TABLE DCategory (
    dcategoryNo int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    categoryNo int NOT NULL,
    dcategoryName varchar(200) NOT NULL
);
-- DCategory 테이블과 Category 테이블의 외래 키
ALTER TABLE DCategory
ADD CONSTRAINT FK_Category_TO_DCategory FOREIGN KEY (categoryNo) REFERENCES Category (categoryNo);

-- Product 테이블
CREATE TABLE Product (
    pIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    categoryNo int NOT NULL,
...
CREATE TABLE DStatus (
    dsIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
-- Orders 테이블
CREATE TABLE Orders (
    oIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    dsIdx int NOT NULL,
...
CREATE TABLE BuyList (
    bIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    userIdx int NOT NULL,
    pIdx int NOT NULL,
    oIdx int NOT NULL,
...
-- SCart 테이블
CREATE TABLE SCart (
    scIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    userIdx int NOT NULL,
    pIdx int NOT NULL,
...
-- Review 테이블
CREATE TABLE review (
    rvIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    pIdx int NOT NULL,
    userIdx int NOT NULL,
...
-- Follow 테이블
CREATE TABLE Follow (
    fIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    rvIdx int NOT NULL,
    userIdx int NOT NULL,
...
CREATE TABLE Inquiry (
    inIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    pIdx int NOT NULL,
    userIdx int NOT NULL,
...
-- Answer 테이블
CREATE TABLE Answer (
    aIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
    inIdx int NOT NULL,
    userIdx int NOT NULL,
...
CREATE TABLE Compony (
    comIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Chat_logs (
    chatIdx int PRIMARY KEY NOT NULL AUTO_INCREMENT,
